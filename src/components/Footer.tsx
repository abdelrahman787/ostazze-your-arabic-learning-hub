    ...
    <footer className="relative overflow-hidden text-foreground/75 mt-16">
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-bold text-black dark:text-white mb-5 text-sm">{t("footer_quick_links")}</h4>
          ...
          <div>
            <h4 className="font-bold text-black dark:text-white mb-5 text-sm">{t("footer_about")}</h4>
            <div className="flex flex-col gap-3 text-sm">
              <Link to="/about" className="text-black/60 dark:text-white/60 hover:text-primary transition-colors">{t("footer_about")}</Link>
              <Link to="/contact" className="text-black/60 dark:text-white/60 hover:text-primary transition-colors">{t("footer_contact")}</Link>
              <Link to="/terms" className="text-black/60 dark:text-white/60 hover:text-primary transition-colors">{t("footer_terms")}</Link>
