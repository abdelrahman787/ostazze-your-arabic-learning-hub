...
export const mockReviews: Review[] = [
  ...
  { id: "3", studentName: { ar: "فهد العتيبي", en: "Fahd Al-Otaibi" }, rating: 4, comment: { ar: "شرح واضح ومنظم. أنصح به بشدة.", en: "Clear and organized explanation. I highly recommend." }, date: { ar: "قبل أسبوعين", en: "2 weeks ago" }, university: pickKsaUni() },
