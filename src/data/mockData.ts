...
export const mockReviews: Review[] = [
  { id: "1", studentName: { ar: "عبدالله السالم", en: "Abdullah Al-Salem" }, rating: 5, comment: { ar: "معلم ممتاز جداً، يشرح بطريقة مبسطة وسهلة الفهم.", en: "Excellent teacher, explains in a simple and easy-to-understand way." }, date: { ar: "قبل 3 أيام", en: "3 days ago" }, university: { ar: "جامعة القاهرة", en: "Cairo University" } },
  { id: "2", studentName: { ar: "مريم الحسن", en: "Maryam Al-Hassan" }, rating: 5, comment: { ar: "أفضل معلم رياضيات! ساعدني في رفع درجاتي بشكل ملحوظ.", en: "Best math teacher! Helped me significantly improve my grades." }, date: { ar: "قبل أسبوع", en: "1 week ago" }, university: { ar: "جامعة عين شمس", en: "Ain Shams University" } },
  ...
  { id: "4", studentName: { ar: "لينا محمد", en: "Lina Mohammed" }, rating: 5, comment: { ar: "تجربة تعليمية رائعة! المعلم صبور ومتفهم.", en: "Wonderful learning experience! The teacher is patient and understanding." }, date: { ar: "قبل 3 أسابيع", en: "3 weeks ago" }, university: { ar: "الجامعة الأمريكية بالقاهرة", en: "American University in Cairo" } },
  { id: "5", studentName: { ar: "أحمد الغامدي", en: "Ahmed Al-Ghamdi" }, rating: 5, comment: { ar: "جلسات احترافية جداً، استخدام ممتاز للوسائل التعليمية.", en: "Very professional sessions, excellent use of teaching tools." }, date: { ar: "قبل شهر", en: "1 month ago" }, university: { ar: "جامعة عين شمس", en: "Ain Shams University" } },
];

export const mockTestimonials = [
  { name: { ar: "عبدالله المالكي", en: "Abdullah Al-Malki" }, university: { ar: "جامعة القاهرة", en: "Cairo University" }, quote: { ar: "بفضل Ostaze، تمكنت من رفع معدلي في مادة التفاضل والتكامل من C إلى A+.", en: "Thanks to Ostaze, I was able to raise my Calculus grade from C to A+." }, avatar: "/__l5e/assets-v1/65a4dec8-a28e-4e6b-94d9-fd81a043941f/abdullah-al-malki.png" },
  { name: { ar: "نورا الشمري", en: "Noura Al-Shammari" }, university: { ar: "جامعة عين شمس", en: "Ain Shams University" }, quote: { ar: "أفضل منصة تعليمية استخدمتها! حجز الجلسات سهل والمعلمون متميزون.", en: "Best learning platform I've used! Booking sessions is easy and the teachers are outstanding." }, avatar: "/__l5e/assets-v1/191d2b13-b086-4aa6-97aa-33908812c022/noura-al-shammari.png" },
  { name: { ar: "فيصل الدوسري", en: "Faisal Al-Dosari" }, university: { ar: "الأكاديمية العربية للعلوم والتكنولوجيا والنقل البحري", en: "AAST" }, quote: { ar: "ساعدتني المنصة في التغلب على صعوبات مادة الفيزياء.", en: "The platform helped me overcome difficulties in Physics." }, avatar: "/__l5e/assets-v1/c8c0f117-52b9-44d0-b310-6ca6698f1595/faisal-al-dosari.png" },
];
