    ...
    colleges: [
      {
        ...
        name_en: "College of Engineering",
        departments: [
          { id: "QA-QU-ENG-ARCH", name_ar: "قسم العمارة والتخطيط العمراني", name_en: "Department of Architecture and Urban Planning", degrees: ["BSc","MSc","PhD"], courses: [] },
          { id: "QA-QU-ENG-CHEM", name_ar: "قسم الهندسة الكيميائية", name_en: "Department of Chemical Engineering", degrees: ["BSc","MSc","PhD"],
            ...
            courses: [
              { code: "CHEM 209", name_en: "Fundamentals in Organic Chemistry", name_ar: "أساسيات الكيمياء العضوية", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 201", name_en: "Introduction to Chemical Engineering I", name_ar: "مقدمة في الهندسة الكيميائية 1", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 202", name_en: "Introduction to Chemical Engineering II", name_ar: "مقدمة في الهندسة الكيميائية 2", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 212", name_en: "Chemical Engineering Thermodynamics I", name_ar: "الديناميكا الحرارية للهندسة الكيميائية 1", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 213", name_en: "Fluid Mechanics", name_ar: "ميكانيكا الموائع", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 235", name_en: "Physical Chemistry for Chemical Engineers", name_ar: "الكيمياء الفيزيائية لمهندسي الكيمياء", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 311", name_en: "Heat Transfer", name_ar: "انتقال الحرارة", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 312", name_en: "Chemical Engineering Thermodynamics II", name_ar: "الديناميكا الحرارية للهندسة الكيميائية 2", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 313", name_en: "Mass Transfer I", name_ar: "انتقال الكتلة 1", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 314", name_en: "Chemical Reaction Engineering", name_ar: "هندسة التفاعلات الكيميائية", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 315", name_en: "Mass Transfer II", name_ar: "انتقال الكتلة 2", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 324", name_en: "Fluid Mechanics and Heat Transfer Lab", name_ar: "مختبر ميكانيكا الموائع وانتقال الحرارة", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 325", name_en: "Unit Operations Lab", name_ar: "مختبر العمليات الوحدوية", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 327", name_en: "Computer Methods in Chemical Engineering", name_ar: "الطرق الحاسوبية في الهندسة الكيميائية", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 399", name_en: "Practical Training", name_ar: "التدريب العملي", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHEM-ELEC-21", name_en: "Major Elective I", name_ar: "مادة اختيارية تخصصية 1", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHEM-ELEC-22", name_en: "Major Elective II", name_ar: "مادة اختيارية تخصصية 2", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHEM-ELEC-23", name_en: "Major Elective III", name_ar: "مادة اختيارية تخصصية 3", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHEM-ELEC-24", name_en: "Major Elective IV", name_ar: "مادة اختيارية تخصصية 4", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 406", name_en: "Chemical Process Industries", name_ar: "صناعات العمليات الكيميائية", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 421", name_en: "Senior Design Project I", name_ar: "مشروع التصميم النهائي 1", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 422", name_en: "Senior Design Project II", name_ar: "مشروع التصميم النهائي 2", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 423", name_en: "Process Control", name_ar: "التحكم في العمليات", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 426", name_en: "Reaction Engineering and Process Control Lab", name_ar: "مختبر هندسة التفاعلات والتحكم في العمليات", credits: 1, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
              { code: "CHME 458", name_en: "Process Safety and Hazards Prevention", name_ar: "سلامة العمليات ومنع المخاطر", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-CHEM-BSC"] },
            ]
          },
          ...
          { id: "QA-QU-ENG-CS", name_ar: "قسم علوم وهندسة الحاسب", name_en: "Department of Computer Science and Engineering", degrees: ["BSc"],
            programs: [
            ...
            courses: [
              ...
              { code: "CMPS 151", name_en: "Programming Concepts", name_ar: "مفاهيم البرمجة", credits: 3, year: 1, semester: 1, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "ENGL 202", name_en: "English Language I (Post-Foundation)", name_ar: "اللغة الإنجليزية 1", credits: 3, year: 1, semester: 1, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "HIST 121", name_en: "History of Qatar", name_ar: "تاريخ قطر", credits: 3, year: 1, semester: 1, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "MATH 101", name_en: "Calculus I", name_ar: "التفاضل والتكامل 1", credits: 3, year: 1, semester: 1, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "CMPS 251", name_en: "Object-Oriented Programming", name_ar: "البرمجة الكائنية التوجه", credits: 4, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "ENGL 203", name_en: "English Language II (Post-Foundation)", name_ar: "اللغة الإنجليزية 2", credits: 3, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "MATH 102", name_en: "Calculus II", name_ar: "التفاضل والتكامل 2", credits: 3, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "MATH 231", name_en: "Linear Algebra", name_ar: "الجبر الخطي", credits: 3, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "PHYS 191", name_en: "General Physics for Engineering I", name_ar: "الفيزياء العامة للهندسة 1", credits: 3, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "PHYS 192", name_en: "Experimental General Physics for Engineering I", name_ar: "الفيزياء العامة العملية للهندسة 1", credits: 1, year: 1, semester: 2, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "ARAB 100", name_en: "Arabic Language I", name_ar: "اللغة العربية 1", credits: 3, year: 2, semester: 3, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "CMPS 205", name_en: "Discrete Structures for Computing", name_ar: "التراكيب المنفصلة للحوسبة", credits: 3, year: 2, semester: 3, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "CMPS 303", name_en: "Data Structures", name_ar: "هياكل البيانات", credits: 4, year: 2, semester: 3, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "CMPE 263", name_en: "Computer Architecture and Organization I", name_ar: "معمارية وتنظيم الحاسوب 1", credits: 3, year: 2, semester: 4, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              { code: "CMPS 323", name_en: "Design and Analysis of Algorithms", name_ar: "تصميم وتحليل الخوارزميات", credits: 3, year: 2, semester: 4, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              ...
              { code: "CS-ELEC-Core-Knowledge-and-Skills-Package-1", name_en: "Core Knowledge and Skills Package", name_ar: "حزمة المعارف والمهارات الأساسية", credits: 3, year: 2, semester: 4, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              ...
              { code: "GENG 200", name_en: "Probability and Statistics for Engineers", name_ar: "الاحتمالات والإحصاء للمهندسين", credits: 3, year: 2, semester: 4, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "CMPS 380", name_en: "Cybersecurity Fundamentals", name_ar: "أساسيات الأمن السيبراني", credits: 3, year: 3, semester: 5, term: "Fall", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "CS-ELEC-Major-Elective-I-2", name_en: "Major Elective I", name_ar: "مادة اختيارية تخصصية 1", credits: 3, year: 3, semester: 5, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "CS-ELEC-Natural-Science/Mathematics-Package-3", name_en: "Natural Science/Mathematics Package", name_ar: "حزمة العلوم الطبيعية/الرياضيات", credits: 3, year: 3, semester: 5, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              ...
              { code: "CS-ELEC-Major-Elective-II-4", name_en: "Major Elective II", name_ar: "مادة اختيارية تخصصية 2", credits: 3, year: 3, semester: 6, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "DAWA 111", name_en: "Islamic Culture", name_ar: "الثقافة الإسلامية", credits: 3, year: 3, semester: 6, term: "Spring", type: "Required", program_ids: ["QA-QU-ENG-CS-BSC-CS", "QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "CS-ELEC-Humanities/Fine-Arts-Package-6", name_en: "Humanities/Fine Arts Package", name_ar: "حزمة العلوم الإنسانية/الفنون", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "CS-ELEC-Major-Elective-I-10", name_en: "Major Elective I", name_ar: "مادة اختيارية تخصصية 1", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CE"] },
              { code: "CS-ELEC-Major-Elective-II-11", name_en: "Major Elective II", name_ar: "مادة اختيارية تخصصية 2", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CE"] },
              { code: "CS-ELEC-Major-Elective-III-5", name_en: "Major Elective III", name_ar: "مادة اختيارية تخصصية 3", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "CS-ELEC-Social/Behavioral-Sciences-Package-9", name_en: "Social/Behavioral Sciences Package", name_ar: "حزمة العلوم الاجتماعية/السلوكية", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CE"] },
              ...
              { code: "CS-ELEC-Major-Elective-III-12", name_en: "Major Elective III", name_ar: "مادة اختيارية تخصصية 3", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CE"] },
              { code: "CS-ELEC-Major-Elective-IV-13", name_en: "Major Elective IV", name_ar: "مادة اختيارية تخصصية 4", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CE"] },
              { code: "CS-ELEC-Major-Elective-IV-7", name_en: "Major Elective IV", name_ar: "مادة اختيارية تخصصية 4", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
              { code: "CS-ELEC-Social/Behavioral-Sciences-Package-8", name_en: "Social/Behavioral Sciences Package", name_ar: "حزمة العلوم الاجتماعية/السلوكية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-CS-BSC-CS"] },
          ...
          { id: "QA-QU-ENG-ELEC", name_ar: "قسم الهندسة الكهربائية", name_en: "Department of Electrical Engineering", degrees: ["BSc","MSc","PhD"],
            ...
            courses: [
              { code: "ELEC 210", name_en: "Electric Circuits I", name_ar: "الدوائر الكهربائية 1", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 211", name_en: "Electric Circuits I Laboratory", name_ar: "مختبر الدوائر الكهربائية 1", credits: 1, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 212", name_en: "Electric Circuits II", name_ar: "الدوائر الكهربائية 2", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 213", name_en: "Electric Circuits II Laboratory", name_ar: "مختبر الدوائر الكهربائية 2", credits: 1, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 231", name_en: "Electronic Devices & Circuits", name_ar: "الأجهزة والدوائر الإلكترونية", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 261", name_en: "Digital Systems Design", name_ar: "تصميم النظم الرقمية", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 262", name_en: "Digital Systems Design Laboratory", name_ar: "مختبر تصميم النظم الرقمية", credits: 1, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "MATH 285", name_en: "Mathematics for Electrical Engineers", name_ar: "الرياضيات للهندسة الكهربائية", credits: 3, year: 2, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 311", name_en: "Electromagnetics", name_ar: "الكهرومغناطيسية", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 312", name_en: "Electric Machines", name_ar: "الآلات الكهربائية", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 313", name_en: "Electric Machines Laboratory", name_ar: "مختبر الآلات الكهربائية", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 322", name_en: "Power Systems", name_ar: "نظم القوى الكهربائية", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 323", name_en: "Power Systems Laboratory", name_ar: "مختبر نظم القوى الكهربائية", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 325", name_en: "Power Electronics", name_ar: "إلكترونيات القوى", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 341", name_en: "Communication Engineering", name_ar: "هندسة الاتصالات", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 342", name_en: "Communication Engineering Lab", name_ar: "مختبر هندسة الاتصالات", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 351", name_en: "Signals and Systems", name_ar: "الإشارات والأنظمة", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 352", name_en: "Control Systems", name_ar: "أنظمة التحكم", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 353", name_en: "Signal Analysis & Filtering", name_ar: "تحليل وترشيح الإشارات", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 366", name_en: "Embedded Systems", name_ar: "النظم المدمجة", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 367", name_en: "Embedded Systems Laboratory", name_ar: "مختبر النظم المدمجة", credits: 1, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 371", name_en: "Electronic Systems", name_ar: "النظم الإلكترونية", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 399", name_en: "Practical Training", name_ar: "التدريب العملي", credits: 3, year: 3, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 491", name_en: "Electrical Engineering Systems Design", name_ar: "تصميم نظم الهندسة الكهربائية", credits: 1, year: 4, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 498", name_en: "Senior Design Project I", name_ar: "مشروع التصميم النهائي 1", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC 499", name_en: "Senior Design Project II", name_ar: "مشروع التصميم النهائي 2", credits: 3, year: 4, type: "Required", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC-ELEC-26", name_en: "Major Elective I", name_ar: "مادة اختيارية تخصصية 1", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC-ELEC-27", name_en: "Major Elective II", name_ar: "مادة اختيارية تخصصية 2", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC-ELEC-28", name_en: "Major Elective III", name_ar: "مادة اختيارية تخصصية 3", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
              { code: "ELEC-ELEC-29", name_en: "Major Elective IV", name_ar: "مادة اختيارية تخصصية 4", credits: 3, year: 4, type: "Elective", program_ids: ["QA-QU-ENG-ELEC-BSC"] },
            ]
          },
          { id: "QA-QU-ENG-MECH", name_ar: "قسم الهندسة الميكانيكية والصناعية", name_en: "Department of Mechanical and Industrial Engineering", degrees: ["BSc"],
            programs: [
            ...
            courses: [
              ...
              { code: "ME-ELEC-Core-Curriculum-Elective-2", name_en: "Core Curriculum Elective", name_ar: "مادة اختيارية من المتطلبات الأساسية", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ME"] },
              { code: "ME-ELEC-Major-Elective-6", name_en: "Major Elective", name_ar: "مادة اختيارية تخصصية", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ISE"] },
              { code: "ME-ELEC-Major-Elective-I-1", name_en: "Major Elective I", name_ar: "مادة اختيارية تخصصية 1", credits: 3, year: 4, semester: 7, term: "Fall", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ME"] },
              ...
              { code: "ME-ELEC-Core-Curriculum-Elective-10", name_en: "Core Curriculum Elective", name_ar: "مادة اختيارية من المتطلبات الأساسية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ISE"] },
              { code: "ME-ELEC-Core-Curriculum-Elective-3", name_en: "Core Curriculum Elective", name_ar: "مادة اختيارية من المتطلبات الأساسية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ME"] },
              { code: "ME-ELEC-Core-Curriculum-Elective-9", name_en: "Core Curriculum Elective", name_ar: "مادة اختيارية من المتطلبات الأساسية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ISE"] },
              { code: "ME-ELEC-Major-Elective-7", name_en: "Major Elective", name_ar: "مادة اختيارية تخصصية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ISE"] },
              { code: "ME-ELEC-Major-Elective-8", name_en: "Major Elective", name_ar: "مادة اختيارية تخصصية", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ISE"] },
              { code: "ME-ELEC-Major-Elective-II-4", name_en: "Major Elective II", name_ar: "مادة اختيارية تخصصية 2", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ME"] },
              { code: "ME-ELEC-Major-Elective-III-5", name_en: "Major Elective III", name_ar: "مادة اختيارية تخصصية 3", credits: 3, year: 4, semester: 8, term: "Spring", type: "Elective", program_ids: ["QA-QU-ENG-MECH-BSC-ME"] },
